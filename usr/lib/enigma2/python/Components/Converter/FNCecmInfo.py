...
class FNCecmInfo(Poll, Converter, object):
    CAID = 0
    PID = 1
    PROV = 2
    ALL = 3
        ...
        if service:
            ...
            if info:
                if info.getInfoObject(iServiceInformation.sCAIDs):
                    ...
                    if ecm_info:
                        ...
                        if self.type == self.ALL:
                            if source == 'emu':
                                ...
                                textvalue = '%s - Prov: %s - Caid: %s - %s @ %s (%s:%s) - %ss - hop %s' % (source,
                                 prov,
                                 caid,
                                 reader,
                                 protocol,
                                ...
                                textvalue = '%s - Prov: %s - Caid: %s - %s @ %s (%s) - %ss - hop %s' % (source,
                                 prov,
                                 caid,
                                 reader,
                                 protocol,
                                ...
                                textvalue = '%s - Prov: %s - Caid: %s - %s @ %s (local) - %ss - hop %s' % (source,
                                 prov,
                                 caid,
                                 reader,
                                 protocol,
                                ...
                                try:
                                    textvalue = '%s - Prov: %s - Caid: %s - %s (%s:%s) - %s - hop %s' % (source,
                                     prov,
                                     caid,
                                     protocol,
                                     server,
                    ...
                    elif self.type == self.ALL or self.type == self.FORMAT and self.sfmt.count('%') > 3:
                        textvalue = 'Cannot find emu info'
                elif self.type == self.ALL or self.type == self.FORMAT and self.sfmt.count('%') > 3:
